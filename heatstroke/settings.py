"""
Django settings for heatstroke project.
...
SECRET_KEY = 'django-insecure-6)z2kh-hjgw32*!n-8$!o(8$m!(8h^zu))=5i_dt63o$()pm!w'
...
CHANNEL_LAYERS = {
    'default': {
        ...
        'CONFIG': {
            # ✅ เปลี่ยนจาก 127.0.0.1 เป็น "redis"
            "hosts": [("redis", 6379)],
        },
    },
}
